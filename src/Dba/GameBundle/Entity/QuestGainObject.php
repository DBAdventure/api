 ...
 * Quest Gain Object
 *
 * @ORM\Table(name="quest_gain_object", indexes={@ORM\Index(name="quest_gain_object_quest_id", columns={"quest_id"}),
   @ORM\Index(name="quest_gain_object_object_id", columns={"object_id"})})
 * @ORM\Entity(repositoryClass="Dba\GameBundle\Repository\QuestObjectRepository")
 */
class QuestGainObject
{
    /**
     * @var Quest
     * @ORM\Id
